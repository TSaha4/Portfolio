...
const skills = [
  ...
  { name: "Sentence TFs", icon: MessageSquareText, color: "#4ade80" },
...
export function SkillsSection() {
  ...
  return (
    <section id="skills" className="py-12 md:py-20 px-6" ref={ref}>
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          className="flex flex-wrap justify-center gap-2 sm:gap-4 md:gap-3 lg:gap-3.5 group/skills"
        >
          {skills.map((skill, index) => (
            <motion.div
              ...
              className="relative w-[76px] xs:w-[84px] sm:w-[86px] md:w-[90px] lg:w-[88px] xl:w-[92px] flex-shrink-0"
            >
              <div
                className="flex flex-col items-center justify-start py-2.5 px-0.5 sm:p-4 rounded-xl bg-[var(--glass-bg)] backdrop-blur-xl border border-[var(--glass-border)] transition-all duration-500 h-full md:grayscale md:opacity-60 md:group-hover/skills:grayscale md:group-hover/skills:opacity-30 md:hover:!grayscale-0 md:hover:!opacity-100 md:hover:scale-110 md:hover:bg-primary/10 md:hover:border-primary/50 md:hover:shadow-xl md:hover:shadow-primary/20 hover:scale-105 hover:shadow-lg"
              >
                <div className="relative w-6 h-6 sm:w-10 sm:h-10 md:w-12 md:h-12 flex items-center justify-center mb-1.5 flex-shrink-0">
                ...
                <span className="text-[9px] xs:text-[10px] sm:text-xs font-semibold text-center text-foreground leading-tight break-normal whitespace-normal w-full md:px-1">
                  {skill.name}
                </span>
              </div>
            </motion.div>
